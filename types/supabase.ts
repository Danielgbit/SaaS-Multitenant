  ...
  public: {
    Tables: {
      ...
      client_account_transactions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "client_account_transactions_appointment_id_fkey"
            columns: ["appointment_id"]
            isOneToOne: false
            referencedRelation: "appointments"
            referencedColumns: ["id"]
      ...
      client_product_discounts: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["inventory_item_id"]
            isOneToOne: false
            referencedRelation: "inventory_reconciliation_view"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      inventory_divergences: {
        Row: {
          ...
          resolved_current_stock: number | null
          resolved_ledger_stock: number | null
          status: string
        ...
        Relationships: [
          {
            foreignKeyName: "inventory_divergences_inventory_item_id_fkey"
            columns: ["inventory_item_id"]
            isOneToOne: false
            referencedRelation: "inventory_items"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "inventory_divergences_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
      ...
      operation_entries: {
        ...
        Relationships: [
          {
            foreignKeyName: "operation_entries_cash_session_id_fkey"
    ...
    Views: {
      cash_session_summary: {
        Row: {
          active_entries_count: number | null
          closed_at: string | null
          closed_by: string | null
          created_at: string | null
          expected_cash: number | null
          expected_cash_detail: Json | null
    ...
    Functions: {
      ...
      get_inventory_divergences: {
        ...
        Returns: {
          ...
          id: string
          inventory_item_id: string
          last_movement_created_at: string
      ...
      get_low_stock_items: {
        Args: { p_include_zero_min?: boolean; p_organization_id: string }
        Returns: {
          active: boolean | null
          category: string | null
          cost_price: number | null
