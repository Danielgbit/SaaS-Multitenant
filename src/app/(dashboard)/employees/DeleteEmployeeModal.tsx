...
export function DeleteEmployeeModal({ employee, onClose }: DeleteEmployeeModalProps) {
  ...
  return (
    <Modal isOpen={true} onClose={onClose} title="Archivar empleado">
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <label htmlFor="modal-archive-reason" className="text-xs font-semibold text-[#475569] dark:text-[#94A3B8]">Razón (opcional)</label>
          <textarea id="modal-archive-reason" value={reason} onChange={(e) => setReason(e.target.value)}
