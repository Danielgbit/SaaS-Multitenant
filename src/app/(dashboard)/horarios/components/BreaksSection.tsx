            ...
            return (
              ...
              >
                ...
                {quickOverrideEmpId === employee.id && (
                  <div className="px-4 pb-4 bg-amber-500/5 border-t border-amber-500/20">
                    <div className="flex items-center gap-2 pt-3 pb-2">
                      <Calendar className="w-3.5 h-3.5 text-amber-400" />
                      <span className="text-[11px] font-semibold text-amber-400 uppercase tracking-wider">
                        Excepción por fecha (solo este día)
                      </span>
                    </div>
                    <form
                      onSubmit={(e) => {
                    ...
                    >
                      <div>
                        <label className="block text-[10px] text-slate-400 mb-1">Día de la semana</label>
                        ...
                        {quickOverrideForm.date && !showDatePicker && (
                          <p className="text-[10px] text-slate-500 mt-1">
                            → {new Date(quickOverrideForm.date + 'T00:00:00').toLocaleDateString('es-ES', { day: 'numeric', month: 'long', year: 'numeric' })}
                            {' '}
                            <button
                              type="button"
                              onClick={() => setShowDatePicker(true)}
                              className="text-[#38BDF8] hover:text-[#38BDF8]/80 underline transition-colors cursor-pointer"
                            >
                              Otra fecha
                            </button>
                          </p>
                        ...
                        {showDatePicker && (
                          <div className="mt-1">
                            <input
                              ...
                              className="w-32 px-2.5 py-1.5 rounded-lg border border-slate-600/50 bg-slate-700/50 text-white text-xs focus:outline-none focus:ring-2 focus:ring-[#38BDF8]/40"
                            />
                          </div>
                        )}
                      </div>
                      <div>
                        ...
                        <input
                          ...
                          className="w-22 px-2.5 py-1.5 rounded-lg border border-slate-600/50 bg-slate-700/50 text-white text-xs focus:outline-none focus:ring-2 focus:ring-[#38BDF8]/40"
                        />
                      </div>
                      <span className="text-slate-500 text-xs pb-3">→</span>
                      <div>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className="w-28 px-2.5 py-1.5 rounded-lg border border-slate-600/50 bg-slate-700/50 text-white text-xs focus:outline-none focus:ring-2 focus:ring-[#38BDF8]/40 placeholder:text-slate-500"
                        />
                      </div>
                      <button
                        type="submit"
                        disabled={isSavingQuickOverride}
                        className="px-3 py-1.5 rounded-lg bg-[#38BDF8] text-white text-xs font-medium hover:bg-[#38BDF8]/90 transition-all duration-200 disabled:opacity-50 cursor-pointer"
                      >
