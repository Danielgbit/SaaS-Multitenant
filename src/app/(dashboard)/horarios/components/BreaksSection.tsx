      ...
      {showCreateForm && (
        <div className="mb-6 p-5 bg-slate-700/50 rounded-xl border border-slate-600/30">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-base font-semibold text-white">Nuevo descanso</h3>
            <button
                            ...
                            return (
                              ...
                              >
                                ...
                                <div className="flex items-center gap-2 sm:w-28 flex-shrink-0">
                                  <span className="text-sm font-medium text-white w-16">{day?.short}</span>
                                  <span className="text-xs text-slate-400">{av.start_time.slice(0, 5)}-{av.end_time.slice(0, 5)}</span>
                                </div>
