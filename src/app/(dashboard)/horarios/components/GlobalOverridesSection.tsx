...
export function GlobalOverridesSection({
  ...
  return (
    <section className="mb-8 p-5 sm:p-6 bg-white dark:bg-slate-800/80 rounded-2xl border border-slate-200 dark:border-slate-700/50 shadow-xl backdrop-blur-sm">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        {!showForm && (
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-xl bg-[#0F4C5C]/10 dark:bg-[#38BDF8]/10 text-[#0F4C5C] dark:text-[#38BDF8] font-medium text-sm hover:bg-[#0F4C5C]/20 dark:hover:bg-[#38BDF8]/20 transition-all duration-200 cursor-pointer"
          >
      ...
      {/* Form */}
      {showForm && (
        <form onSubmit={handleCreate} className="mb-5 p-4 bg-slate-50 dark:bg-slate-700/50 rounded-xl border border-slate-200 dark:border-slate-600/30">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-xl border border-slate-200 dark:border-slate-600/50 bg-white dark:bg-slate-700/50 text-slate-900 dark:text-white text-sm
                           focus:outline-none focus:ring-2 focus:ring-[#0F4C5C]/40 dark:focus:ring-[#38BDF8]/40 focus:border-[#0F4C5C] dark:focus:border-[#38BDF8]
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-xl border border-slate-200 dark:border-slate-600/50 bg-white dark:bg-slate-700/50 text-slate-900 dark:text-white text-sm
                           focus:outline-none focus:ring-2 focus:ring-[#0F4C5C]/40 dark:focus:ring-[#38BDF8]/40 focus:border-[#0F4C5C] dark:focus:border-[#38BDF8]
                           placeholder:text-slate-400 dark:placeholder:text-slate-500 transition-all duration-200 cursor-pointer"
              />
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 mb-4">
            <label className="flex items-center gap-2 cursor-pointer">
              <input
                ...
                className="w-4 h-4 rounded border-slate-300 dark:border-slate-500 text-[#0F4C5C] dark:text-[#38BDF8] focus:ring-[#0F4C5C]/40 dark:focus:ring-[#38BDF8]/40 bg-white dark:bg-slate-700 cursor-pointer"
              />
          ...
          <div className="flex gap-2">
            <button
              type="submit"
              disabled={isCreating}
              className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#0F4C5C] dark:bg-[#38BDF8] text-white font-medium text-sm hover:bg-[#0C3E4A] dark:hover:bg-[#38BDF8]/90 transition-all duration-200 disabled:opacity-60 cursor-pointer"
            >
      ...
      {!showForm && overrides.length === 0 && (
        <div className="p-6 bg-slate-50 dark:bg-slate-700/30 rounded-xl border border-slate-200 dark:border-slate-600/20">
          {/* Icon */}
          <div className="flex justify-center mb-5">
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-slate-100 to-slate-200 dark:from-slate-600/40 dark:to-slate-700/40 backdrop-blur-sm flex items-center justify-center">
          ...
          {/* Description */}
          <p className="text-sm text-slate-600 dark:text-slate-300 text-center leading-relaxed mb-5">
          ...
          <div className="flex flex-wrap justify-center gap-2 mb-5">
            <span className="px-3 py-1.5 rounded-full bg-slate-100 dark:bg-slate-600/30 text-slate-600 dark:text-slate-300 text-xs">
              Feriados
            </span>
            <span className="px-3 py-1.5 rounded-full bg-slate-100 dark:bg-slate-600/30 text-slate-600 dark:text-slate-300 text-xs">
              Mantenimiento
          ...
          <button
            onClick={() => setShowForm(true)}
            className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-[#0F4C5C] dark:bg-[#38BDF8] text-white font-medium hover:bg-[#0C3E4A] dark:hover:bg-[#38BDF8]/90 hover:shadow-lg hover:shadow-[#38BDF8]/20 transition-all duration-200 cursor-pointer mb-4"
          >
            <Plus className="w-4 h-4" />
