  ...
  try {
    const { data, error } = await supabase
      ...
      .insert({
        ...
        variables: validation.data.variables as unknown as Json,
...
export async function updateTemplate(
  ...
  try {
    ...
    if (validation.data.variables !== undefined) updateData.variables = validation.data.variables as unknown as Json
