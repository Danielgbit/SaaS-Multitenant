...
export type EntryType = 'income' | 'expense' | 'payroll_expense' | 'inventory_out' | 'adjustment' | 'note' | 'break'
export type EntryStatus = 'active' | 'voided'
export type CreatedVia = 'manual' | 'appointment_auto' | 'payroll_auto' | 'inventory_auto' | 'migration'
export type EntryDirection = 'in' | 'out'
export type PaymentMethod = 'cash' | 'qr' | 'transfer' | 'card'
export type SourceType = 'appointment' | 'payroll' | 'inventory' | 'manual'
...
export const ENTRY_TYPE_LABELS: Record<EntryType, string> = { income: 'Ingreso', expense: 'Gasto', payroll_expense: 'Pago Nómina', inventory_out: 'Salida Inventario', adjustment: 'Ajuste', note: 'Nota', break: 'Descanso' }
