...
export type EntryType = 'income' | 'product_sale' | 'expense' | 'inventory_purchase' | 'payroll_expense' | 'inventory_out' | 'adjustment' | 'note' | 'break' | 'account_payment'
export type EntryGroup = 'operational' | 'inventory' | 'payroll' | 'system'
export type EntryStatus = 'active' | 'voided'
export type CreatedVia = 'manual' | 'appointment_auto' | 'payroll_auto' | 'inventory_auto' | 'product_sale_hook' | 'record_payment' | 'migration'
export type EntryDirection = 'in' | 'out'
export type PaymentMethod = 'cash' | 'qr' | 'transfer' | 'card'
export type SourceType = 'appointment' | 'payroll' | 'inventory' | 'inventory_sale' | 'client_account_payment' | 'manual'
...
export const ENTRY_TYPE_LABELS: Record<EntryType, string> = { income: 'Ingreso', product_sale: 'Venta Producto', expense: 'Gasto', inventory_purchase: 'Compra Inventario', payroll_expense: 'Pago Nómina', inventory_out: 'Consumo Interno', adjustment: 'Ajuste', note: 'Nota', break: 'Descanso', account_payment: 'Pago de Cuenta' }
...
export const ENTRY_GROUP_MAP: Record<EntryType, EntryGroup> = {
  ...
  adjustment: 'system', note: 'system', break: 'system', account_payment: 'operational',
}
