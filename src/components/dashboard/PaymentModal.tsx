...
export function PaymentModal({
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      setTimeElapsed(
        Math.floor((Date.now() - new Date(completedAt).getTime()) / 60000),
      );
    }, 10000);
        ...
        (showSuccess ? (
          ...
          >
            ...
            >
              {/* Header */}
              <div
                className="flex items-center justify-between px-6 py-5 border-b border-slate-200/60 dark:border-slate-700/60"
              ...
              >
                ...
                <button
                  ...
                  className="p-2 rounded-xl transition-colors disabled:opacity-50 hover:bg-[--btn-hover-bg]"
                  style={
                    {
              ...
              <div className="px-6 py-6 space-y-5 max-h-[70dvh] overflow-y-auto">
                ...
                {completedAt && timeElapsed > 0 && (
                  ...
                  >
                    ...
                    <div
                      className="w-full h-1.5 rounded-full bg-white/50"
                      style={
                        {
                      ...
                      ({ code, label, icon: Icon, desc }) => (
                        <button
                          ...
                          style={{
                            ...
                            backgroundColor:
                              selectedMethod === code
                                ? COLORS.accentTealLight
                                : COLORS.surfaceSubtle,
                            boxShadow:
                              selectedMethod === code
                                ? COLORS.shadow.tealMd
                                : "none",
                          }}
                        >
                          <Icon
                          ...
                          />
                          <span
                            className="text-body-xs font-semibold leading-tight text-center"
                            style={{
                              color:
                                selectedMethod === code
                                  ? COLORS.accentTeal
                          ...
                          <span
                            className="text-caption leading-tight text-center"
                            style={{ color: COLORS.textMuted }}
                          >
                            {desc}
                          </span>
                      ...
                      >
                        <div className="flex items-center gap-2 mb-3">
                          <button
                            ...
                            onClick={() =>
                              setAdjustment((prev) =>
                                Math.max(-totalPrice, prev - 10000),
                              )
                            }
                            disabled={isPending}
                        ...
                        {adjustment !== 0 && (
                          <div
                            className="flex justify-between text-sm mb-2 px-1"
                            style={{
                              color:
                                adjustment > 0 ? COLORS.success : COLORS.error,
                            }}
                          >
                            <span>
                              {adjustment > 0 ? "Aumento" : "Descuento"}
                            </span>
              ...
              >
                ...
                >
                  {isPending ? (
                    ...
                    <>
                      <Sparkles className="w-4 h-4" /> Cobrar{" "}
                      {formatCurrencyCOP(finalPrice)}
                    </>
                  )}
                </button>
