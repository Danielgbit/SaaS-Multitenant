        ...
        <AreaChart data={data} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
          <defs>
            <linearGradient id={gradientId} x1="0" y1="0" x2="0" y2="1">
              <stop offset="5%" stopColor={COLORS.accentTeal} stopOpacity={COLORS.isDark ? 0.25 : 0.2} />
              <stop offset="95%" stopColor={COLORS.accentTeal} stopOpacity={0} />
            </linearGradient>
          </defs>
          <CartesianGrid strokeDasharray="3 3" vertical={false} stroke={COLORS.border} strokeOpacity={0.3} />
          <XAxis
            dataKey="label"
            axisLine={false}
            tickLine={false}
